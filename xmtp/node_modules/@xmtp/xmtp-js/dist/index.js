...
var ConversationV1 = class {
  ...
  async buildDecodedMessage(message2, decrypted, topic) {
    const { content, contentType, error, contentFallback } = await decodeContent(decrypted, this.client);
    return DecodedMessage.fromV1Message(
      message2,
      content,
      contentType,
...
var ConversationV2 = class {
  ...
  async buildDecodedMessage(msg, decrypted) {
    ...
    const { content: content$1, contentType, error, contentFallback } = await decodeContent(signed.payload, this.client);
    return DecodedMessage.fromV2Message(
      msg,
      content$1,
      contentType,
...
var DecodedMessage = class {
  ...
  static async fromBytes(data, client) {
    ...
    const { content, contentType, error, contentFallback } = await decodeContent(protoVal.contentBytes, client);
